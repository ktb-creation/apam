...
#
# This file if part of apam project
#
...
class handler(SimpleHTTPServer.SimpleHTTPRequestHandler):
    ## Set server version
    server_version = "apam %s (%s)" %(__version__, __codename__)
    """
...
class apam(object):
    ...
    def serve(self):
        ...
        print("\033[01;35m[i] Starting apam %s server on http://localhost:%d\033[00m" %(__version__, self.port))
